...
<div class="badge">🔥 Sale! Ends in <span id="countdown"></span></div>

<script>
  const targetDate = new Date("2024-12-25T23:59:59").getTime(); // Change to desired date
...
<!--<a class="button button-amazon" href="https://www.pornhub.com/model/sofiaavallone" target="_blank" rel="noopener" role="button">
    <img class="icon" aria-hidden="true" src="images/icons-extended/pornhub.svg" alt="Pornhub Icon">Pornhub (18+)
</a>
<br>-->
